...
from dataset.semi_Androdex import load_dataloader, get_subset_dataloaders
...
#parser.add_argument('--manifest', default='/mnt/d/Data/cicmaldroid_pix2pix/image_pairing_manifest.csv', type=str)
parser.add_argument('--p_obf', default=0.0, type=float,help='원본을 실제 난독화본으로 교체할 확률. 0=baseline')

parser.add_argument('--labeled_id_path',   default='./splits_ssl_androdex/train_labeled.txt')
parser.add_argument('--unlabeled_id_path', default='./splits_ssl_androdex/train_unlabeled.txt')
parser.add_argument('--val_id_path',       default='./splits_ssl_androdex/val_combined.txt')
parser.add_argument('--test_clean_id_path', default='./splits_ssl_androdex/test_clean.txt')
parser.add_argument('--test_obf_id_path',   default='./splits_ssl_androdex/test_obf.txt')
parser.add_argument('--manifest', default='/mnt/d/Data/Androdex/androdex_set2_manifest.csv')
...
# Assuming 'model' is your branch_container
    ...
    if args.ring==False: 
        trainloader_l = load_dataloader(args,'train_l', aug_num=2*length_u)
